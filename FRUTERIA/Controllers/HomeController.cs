...
namespace NAILSART.Controllers
{
    public class HomeController : Controller
    {
        ...
        public void enviarCorreo(string nombre, string apellido, string email, string telefono, string mensaje)
        {
            ...
            string DireccionOrigen = "mariacobo007@gmail.com"; //habra que configurar nuestro gmail cambiando la seg permitiendo aplicaciones menos seguras
            ...
            string pass =  NAILSART.Properties.Resources.Password.ToString();
